...
import { AtomIcon, Share2, Edit, ChevronRight, ArrowRight } from "lucide-react";
    ...
    return (
        <div>
            ...
            <div>
                    ...
                    <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
                        ...
                        <div className="px-4 mx-auto text-center md:max-w-screen-md lg:max-w-screen-lg lg:px-36">
                            ...
                            <div className="flex flex-wrap justify-center items-center mt-8 text-gray-500 sm:justify-between">
                                <div className="mr-5 mb-5 lg:mb-0 hover:text-gray-800 dark:hover:text-gray-400 cursor-pointer">
                                    <svg
                                        className="h-8"
                                        viewBox="0 0 132 29"
                                        fill="none"
                ...
                <section className="py-8 bg-white dark:bg-black dark:text-white z-50 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
                    ...
                    <div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                        <div className="block rounded-xl border bg-white border-gray-200 dark:bg-black dark:border-gray-700 dark:text-white p-8 shadow-xl transition hover:border-green-500/10 hover:shadow-green-500/10 cursor-pointer">
                            ...
                            <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
                                Start by entering your information and let our
                                AI do the heavy lifting. It generates a
                                well-structured resume tailored to your industry
                                and experience.
                            </p>
                        </div>
                        ...
                        <div className="block rounded-xl border bg-white border-gray-200 dark:bg-black dark:border-gray-700 dark:text-white p-8 shadow-xl transition hover:border-green-500/10 hover:shadow-green-500/10 cursor-pointer">
                            ...
                            <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
                                Make any adjustments you like—modify sections,
                                tweak the design, and add personalized details
                        ...
                        <div className="block rounded-xl border bg-white border-gray-200 dark:bg-black dark:border-gray-700 dark:text-white p-8 shadow-xl transition hover:border-green-500/10 hover:shadow-green-500/10 cursor-pointer">
                            ...
                            <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
                                Once you&apos;re satisfied, share your resume
                                directly or download it instantly. Start
                                impressing employers with a polished,
                                professional resume.
                            </p>
                        </div>
                    </div>
